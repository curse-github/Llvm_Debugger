...
declare dso_local void @"?print@@YAXD@Z"(i8 noundef) local_unnamed_addr #0; char
declare dso_local void @"?print@@YAXPEBD@Z"(ptr noundef) local_unnamed_addr #0; str
declare dso_local void @"?print@@YAXI@Z"(i32 noundef) local_unnamed_addr #0; uint32
declare dso_local void @"?print@@YAX_K@Z"(i64 noundef) local_unnamed_addr #0; uint64
declare dso_local void @"?print@@YAXH@Z"(i32 noundef) local_unnamed_addr #0; int32
declare dso_local void @"?print@@YAX_J@Z"(i64 noundef) local_unnamed_addr #0; int64
declare dso_local void @"?print@@YAXM@Z"(float noundef) local_unnamed_addr #0; float
declare dso_local void @"?print@@YAXN@Z"(double noundef) local_unnamed_addr #0; double
;declare dso_local void @"?print@@"(fp128 noundef) local_unnamed_addr #0; fp128
declare dso_local void @"?println@@YAXD@Z"(i8 noundef) local_unnamed_addr #0; char nl
declare dso_local void @"?println@@YAXPEBD@Z"(ptr noundef) local_unnamed_addr #0; str nl
declare dso_local void @"?println@@YAXI@Z"(i32 noundef) local_unnamed_addr #0; uint32 nl
declare dso_local void @"?println@@YAX_K@Z"(i64 noundef) local_unnamed_addr #0; uint64 nl
declare dso_local void @"?println@@YAXH@Z"(i32 noundef) local_unnamed_addr #0; int32 nl
declare dso_local void @"?println@@YAX_J@Z"(i64 noundef) local_unnamed_addr #0; int64 nl
declare dso_local void @"?println@@YAXM@Z"(float noundef) local_unnamed_addr #0; float nl
declare dso_local void @"?println@@YAXN@Z"(double noundef) local_unnamed_addr #0; double nl
;declare dso_local void @"?println@@"(fp128 noundef) local_unnamed_addr #0; fp128 nl
declare dso_local void @"?println@@YAXXZ"() local_unnamed_addr #0; nl
...
define dso_local void @printInt64(i64 noundef %in0) local_unnamed_addr #0 {
    tail call void @"?print@@YAX_J@Z"(i64 noundef %in0)
    ret void
}
...
define dso_local void @printDouble(double noundef %in0) local_unnamed_addr #0 {
    tail call void @"?print@@YAXN@Z"(double noundef %in0)
    ret void
}
...
define dso_local void @printlnInt64(i64 noundef %in0) local_unnamed_addr #0 {
    tail call void @"?println@@YAX_J@Z"(i64 noundef %in0)
    ret void
}
...
define dso_local void @printlnDouble(double noundef %in0) local_unnamed_addr #0 {
    tail call void @"?println@@YAXN@Z"(double noundef %in0)
    ret void
}
